...
print("--- %s seconds ---" % (end_time_caps_2 - start_time_caps_2))
...
print("--- %s seconds ---" % (end_time_cnn_1 - start_time_cnn_1))
...
print("--- %s seconds ---" % (end_time_cnn_2 - start_time_cnn_2))
...
print("Training Time for capsnet glove learn")
print("--- %s seconds ---" % (end_time_caps_2 - start_time_caps_2))


print("Training Time for cnn glove nolearn")
print("--- %s seconds ---" % (end_time_cnn_1 - start_time_cnn_1))
